...
exports.createStudent = async (req, res) => {
  const { name, student_id, class_id, birth_date } = req.body;
  try {
    const result = await pool.query(
      'INSERT INTO students (name, student_id, class_id, birth_date) VALUES ($1, $2, $3, $4) RETURNING *',
      [name, student_id, class_id, birth_date]
    );
