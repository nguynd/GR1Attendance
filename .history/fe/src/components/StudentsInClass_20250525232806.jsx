              ...
              {currentStudents.map((sv, index) => {
                ...
                return (
                  <tr key={sv.id} className="hover:bg-gray-50">
                    <td className="text-[#676f86] border-b border-[#e9f1fe] px-3 py-2">{startIndex + index + 1}</td>
                    <td className="text-[#676f86] border-b border-[#e9f1fe] px-3 py-2">{sv.name}</td>
                    <td className="text-[#676f86] border-b border-[#e9f1fe] px-3 py-2">{sv.student_id}</td>
                    <td className="text-[#676f86] border-b border-[#e9f1fe] px-3 py-2">{formatDate(sv.birth_date)}</td>
